...
            {"pre", new[]       {"style", "class"}},
 
            {"a", new[]          {"style", "class", "href", "title", "target", "rel"}},
            {"img", new[]        {"style", "class", "src", "height",
            ...
            else
            {
              ...
              if (a.Name == "href" || a.Name == "src")
              {
                ...
                a.Value =
                    ...
                    (a.Value.IndexOf("javascript", StringComparison.Ordinal) < 10 || a.Value.IndexOf("eval", StringComparison.Ordinal) < 10)) ?
